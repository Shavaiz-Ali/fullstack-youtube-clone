...
const Player = () => {
    ...
    console.log(data)
  return (
    <div className="xl:max-w-[857.33px] lg:max-w-[757px] h-[380px] bg-[url('/images/stream.jpg')] bg-cover bg-center flex justify-center items-center rounded-[8px] overflow-hidden">
